...
const CACHE_NAME = 'pocus-cardiaco-cache-v17-c3d1-brand1-e1a-e1b-e1c-qa1-qa2-qa3-final-logo2-pwa1-flow1-quick2-reader1-prender1-fate1-ip1-beta1-feedback1-clinical1';
const ASSETS_TO_CACHE = [
  ...
  './assets/js/i18n.js',
  './assets/js/search.js',
  './assets/js/components/protocol-renderer.js',
  './assets/js/router.js',

...
def test_service_worker_and_clinical_unmodified(sw_content):
    # 40. service-worker.js usa v15
    # 42. Los archivos clínicos no se modificaron
    assert "pocus-cardiaco-cache-v13" in sw_content or "pocus-cardiaco-cache-v14" in sw_content or "pocus-cardiaco-cache-v15" in sw_content or "pocus-cardiaco-cache-v16" in sw_content or "pocus-cardiaco-cache-v17" in sw_content

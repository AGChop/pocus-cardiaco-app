...
def test_service_worker_and_clinical_unmodified(sw_content):
    ...
    assert "pocus-cardiaco-cache-v13" in sw_content or "pocus-cardiaco-cache-v14" in sw_content or "pocus-cardiaco-cache-v15" in sw_content or "pocus-cardiaco-cache-v16" in sw_content

...
def test_service_worker_cache_and_contents(sw_content):
    ...
    assert "pocus-cardiaco-cache-v11" in sw_content or "pocus-cardiaco-cache-v12" in sw_content or "pocus-cardiaco-cache-v13" in sw_content or "pocus-cardiaco-cache-v14" in sw_content or "pocus-cardiaco-cache-v15" in sw_content or "pocus-cardiaco-cache-v16" in sw_content or "pocus-cardiaco-cache-v17" in sw_content

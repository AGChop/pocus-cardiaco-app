                ...
                "components": [
                    ...
                    },
                    {
                        ...
                        "clinical_questions": [
                            ...
                            "¿La contractilidad global biventricular parece reducida?"
                        ],
                        "targets": [
                            "Relación cualitativa de tamaño VD/VI (dilatación evidente del VD).",
                            "Estimación cualitativa de la función sistólica global biventricular."
                        ],
                        "suggested_views": [
                            "Apical cuatro cámaras (A4C)"
                        ],
                        ...
                        "possible_findings": [
                            ...
                            "Función sistólica global biventricular aparentemente reducida."
                        ],
                        "interpretation_limits": "La evaluación visual no sustituye la planimetría ni las mediciones formales como el método de Simpson en caso de discrepancias clínicas. La comparación visual VD/VI no establece por sí sola una etiología. Evaluación cualitativa de la función biventricular sin requerir mediciones cuantitativas obligatorias.",
                        "reference_ids": ["jensen_2004"],
                        "quick_reference": {
                            "assess": "Relación cualitativa de tamaño VD/VI y contractilidad global biventricular desde la ventana apical.",
                            "alerts": "Alteración marcada aparente de las dimensiones relativas del VD o contractilidad global biventricular aparentemente deprimida."
                        }
                    },
                    {
                        "id": "parasternal",
